...
public class SendMessageFromSender extends AsyncTask<String, Void, String> {
  private static final String FCM_MESSAGE_URL = "https://fcm.googleapis.com/fcm/send";

  private static final MediaType JSON = MediaType.parse("application/json; charset=utf-8");

  private static final String TAG = SendMessageFromSender.class.getName();
  ...
  protected String doInBackground(String... strings) {
    ...
    try {
      ...
      data.put(PlaceholderFragment.KEY_EXTRA_DATE, Calendar.getInstance().getTimeInMillis());
