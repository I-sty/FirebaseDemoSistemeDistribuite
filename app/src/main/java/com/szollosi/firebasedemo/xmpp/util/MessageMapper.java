...
public class MessageMapper {
  ...
  private static final String TAG = MessageMapper.class.getName();
  ...
  public static String toJsonString(Map<String, Object> jsonMap) {
    try {
      ...
      Log.e(TAG, "Error parsing JSON map: " + jsonMap.values());
    }
    return null;
  }
  ...
  public static Map<String, Object> toMapFromJsonString(String json) {
    try {
      ...
      Log.e(TAG, "Error parsing JSON string: " + json);
    }
    return null;
  }
  ...
  public static CcsInMessage ccsInMessageFrom(Map<String, Object> jsonMap) {
    ...
    return new CcsInMessage(from, category, messageId, dataPayload);
  }
